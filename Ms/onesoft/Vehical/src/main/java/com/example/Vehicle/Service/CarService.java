...
public class CarService {
	...
	//	List<Car> s = Ds.getStart();
	//	Integer collect = s.stream().collect(Collectors.summingInt(x->x.getPrice()));
//		Integer sum = Ds.findAll();
		return Ds.getStart().stream().collect(Collectors.summingInt(x->x.getPrice()));
