...
public class CarController {
	...
	@GetMapping("/getByColor/{a}")
	public List<Car> getByColor(@PathVariable String a){
		return cs.getByColor(a);
	}
	
	@GetMapping("/getByPriceRange/{a}/{b}")
	public List<Car> getPriceRange(@PathVariable int a,@PathVariable int b){
		return cs.getPriceRange(a,b);
	}
