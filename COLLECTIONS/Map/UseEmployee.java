...
public class UseEmployee {
	public static void main(String[] args) {
		...
		*/
		...
		/*Iterator<Employee>emp1=empdetail.values().iterator();
		while (emp1.hasNext()) {
			if(emp1.next().getAge()>26) {
				emp1.remove();
			}
		}
		System.out.println(empdetail);
		*/
		Iterator<Integer>emp2=empdetail.keySet().iterator();
		while (emp2.hasNext()) {
			if(empdetail.get(emp2.next()).getExp()>4) {
				emp2.remove();
			}
		}
		System.out.println(empdetail);
